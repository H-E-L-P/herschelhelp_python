...
def convert_table_for_cigale(catalogue, inplace=False, remove_ulimits=True):
    ...
    - If asked to remove upper limits, set to NaN flux and error for fluxes
      equals to 0.
    ...
    remove_ulimits: boolean
        If remove_ulimits is True (default), all the 0 fluxes and associated
        error are set to NaN.
